...
<asp:Content ID="Main" ContentPlaceHolderID="MainContent" runat="server">
  ...
  <div class="conf">
    ...
    <div class="row muted">Número de orden: <strong><asp:Literal ID="litId" runat="server"/></strong></div>

    <!-- Detalles si están disponibles -->
    <div id="boxDetails" runat="server" visible="false">
      <div class="row"><strong>Título:</strong> <asp:Literal ID="litTitle" runat="server"/></div>
      <div class="row"><strong>Autores:</strong> <asp:Literal ID="litAuthors" runat="server"/></div>
      <div class="row"><strong>Importe:</strong> <asp:Literal ID="litAmount" runat="server"/></div>
      <div class="row"><strong>Estado:</strong> <asp:Literal ID="litStatus" runat="server"/></div>
      <div class="row muted"><asp:Literal ID="litWhen" runat="server"/></div>
    </div>

    <a href="/Home.aspx" class="btn">Volver al inicio</a>
  </div>
</asp:Content>
